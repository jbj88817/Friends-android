...
public class FriendsCustomAdapter extends ArrayAdapter<Friend> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ((TextView) view.findViewById(R.id.tv_friend_name)).setText(name);
        ((TextView) view.findViewById(R.id.tv_friend_phone)).setText(phone);
        ((TextView) view.findViewById(R.id.tv_friend_email)).setText(email);

        Button editButton = (Button) view.findViewById(R.id.btn_edit);
